function [Signal, mic_index] = Load6MicData(SignalParam,FilterParam,filename)
   
    %% 读取数据

    raw_data = double(audioread(['C:\Users\AW\Desktop\Hybrid-Zone-master\Hybrid-Zone-master\PassiveAcousticPerception\Functions\source\',filename,'.wav'],'native')); % filname='0613';
